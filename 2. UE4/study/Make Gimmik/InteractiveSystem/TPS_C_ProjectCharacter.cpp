...
void ATPS_C_ProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ATPS_C_ProjectCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ATPS_C_ProjectCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ATPS_C_ProjectCharacter::OnResetVR);
	PlayerInputComponent->BindAction("Interact", IE_Pressed, this, &ATPS_C_ProjectCharacter::Interaction);
}


void ATPS_C_ProjectCharacter::OnResetVR()
{
	// If TPS_C_Project is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in TPS_C_Project.Build.cs is not automatically propagated
...
void ATPS_C_ProjectCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ATPS_C_ProjectCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
