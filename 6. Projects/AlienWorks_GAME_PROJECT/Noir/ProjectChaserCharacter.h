...
protected:
	...
	virtual void OnSkill_No1_Pressed();
	virtual void OnSkill_No1_Released();
	virtual void OnSkill_No2_Pressed();
	virtual void OnSkill_No2_Released();
	virtual void OnSkill_No3_Pressed();
	virtual void OnSkill_No3_Released();
